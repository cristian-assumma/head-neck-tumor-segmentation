...
default_hooks = dict(
    checkpoint=dict(
        interval=8, rule='greater', save_best='mIoU', type='CheckpointHook'),
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            dict(loss_weight=0.3, per_image=True, type='LovaszLoss'),
...
train_cfg = dict(max_iters=640, type='IterBasedTrainLoop', val_interval=8)
